      ...
      >
        ...
        <div className="mb-16">
          <motion.h3
            ...
            className="text-2xl font-display font-semibold text-center mb-12 text-primary-900 dark:text-primary-100"
          >
            Beyond the Data
          </motion.h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {interests.map((interest, index) => (
              ...
              >
                ...
                {interest.link && (
                  <div className="mt-3 text-xs text-primary-600 dark:text-primary-400 opacity-75">
                    Click to visit →
                  </div>
                )}
              </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sideProjects.map((project, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-white dark:bg-primary-800 p-6 rounded-xl shadow-lg border border-primary-100 dark:border-primary-700 hover:shadow-xl transition-all duration-300"
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-2 py-1 bg-primary-100 dark:bg-primary-700 text-primary-700 dark:text-primary-300 text-xs font-medium rounded"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 transition-colors"
                >
                  View Project
                  <Code size={16} />
                </motion.a>

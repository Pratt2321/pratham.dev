          ...
          >
             ...
             <div>
               <div className="space-y-6">
                 {/* Data Science & ML */}
                 <div>
                   <h5 className="text-lg font-medium text-primary-700 mb-3 flex items-center gap-2">
                   ...
                   <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                     {['Statistics', 'Data Visualization', 'A/B Testing', 'Deep Learning', 'RAG', 'AutoML'].map((skill, index) => (
                       <motion.div
                         ...
                         className="px-4 py-3 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg hover:shadow-md transition-all duration-300"
                       >
                   ...
                   <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                     {['Python', 'R', 'SQL', 'Git', 'Docker', 'AWS'].map((skill, index) => (
                       <motion.div
                         ...
                         whileHover={{ scale: 1.05 }}
                         className="px-4 py-3 bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg hover:shadow-md transition-all duration-300"
                       >
                 ...
                 <div>
                   ...
                   <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                       ...
                       <motion.div
                         ...
                         whileHover={{ scale: 1.05 }}
                         className="px-4 py-3 bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg hover:shadow-md transition-all duration-300"
                       >
